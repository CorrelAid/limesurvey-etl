...
db_name <- Sys.getenv("COOLIFY_PG_DB")
db_host <- Sys.getenv("COOLIFY_PG_HOST")
db_port <- Sys.getenv("COOLIFY_PG_PORT")
db_user <- Sys.getenv("COOLIFY_PG_USER")
db_password <- Sys.getenv("COOLIFY_PG_PASSWORD")
