...
PIPELINE = Pipeline.get_pipeline(
    Path("/opt/airflow/dags/configs/cfe_limesurvey_meta_tables.yaml")
)
...
with DAG(
    dag_id="cfe-limesurvey-meta-tables",
    ...
    trigger_dag_responses_survey_977429 = TriggerDagRunOperator(
        task_id="trigger_dag_responses_survey_977429",
        trigger_dag_id="cfe-limesurvey-responses-survey-977429",
        wait_for_completion=True,
    )


extract_limesurvey_data >> transform >> load_data >> trigger_dag_responses_survey_977429
